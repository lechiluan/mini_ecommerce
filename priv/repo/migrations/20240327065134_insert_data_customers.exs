defmodule MiniEcommerce.Repo.Migrations.InsertDataCustomers do
  ...
  def up do
    ...
    execute("INSERT INTO customers (full_name, address, phone, birth, inserted_at, updated_at) VALUES ('Brian Lee', '789 Oak St', '0386363677', '1985-12-25', NOW(), NOW())")
  ...
  def down do
    ...
    execute("DELETE FROM customers WHERE full_name = 'Brian Lee'")
  end
end
